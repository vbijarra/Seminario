...
public class Soluciones {
	...
	public Soluciones (int Nro_Solucion,
	String Desc_Corta, 
	String Desc_Larga,
	int Error, 
	Date Fecha, 
...
public void Obtener_Soluciones(int tipo_usu, Errores err_inc) throws SQLException { 
	...
	{
		Tipo_Usuario tip_usu = new Tipo_Usuario(); 
		ArrayList<Tipo_Usuario> Soluciones_U_Encontradas = tip_usu.List_Soluciones_Usuario(err_inc);
		...
		Tipo_Tecnica tip_tec = new Tipo_Tecnica(); 
		ArrayList<Tipo_Tecnica> Soluciones_Encontradas =  tip_tec.List_Soluciones_Tecnicas(err_inc);   //sino es usuario es resolutor y muestra todas las soluciones
