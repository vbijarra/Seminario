...
import Soluciones.Soluciones1;
import Soluciones.Tipo_Tecnica1;
import Soluciones.Tipo_Usuario1;
...
public class Incidentes {
	...
	public void Crear_Incidente1(int usu, int tipo_usu) throws SQLException {
		...
		if (confirma == 1) {   
			Errores Nuevo_Error = new Errores(nuevo_incidente.getNro_Incidente(), nuevo_incidente.getFecha(), nuevo_incidente.getUsuario(), nuevo_incidente.getTipo_Problema(),  nuevo_incidente.getPrioridad(), nuevo_incidente.getEstado(), nuevo_incidente.getSolucion() ,  
					codigo, pantalla_Sel,  aplicacion_sel,  modulo_Sel,  proceso_Sel,  descripcion,  pasos, sec_err);
			
			Nuevo_Error.Insertar_Incidente(Nuevo_Error);
			Nuevo_Error.Buscar_Soluciones(Nuevo_Error, tipo_usu);
	...
	public String Ingresa_Descripcion() {
		...
		System.out.println("Descripcion en metodo: " + desc   + " descripcion.length() " + desc.length());
		return 	desc; 
	...
	public void Buscar_Soluciones(Errores err_inc, int tipo_usu) throws SQLException {		
		if (tipo_usu == 1) {
			Soluciones1 solu= new Tipo_Usuario1(); 
			solu.List_Soluciones(err_inc);			
		} else {
			Soluciones1 solu= new Tipo_Tecnica1();
			solu.List_Soluciones(err_inc);
		} 
