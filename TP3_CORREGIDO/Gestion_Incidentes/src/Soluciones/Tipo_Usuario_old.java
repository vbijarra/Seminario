...
public class Tipo_Usuario_old extends Soluciones_old{
	String Path; 
	String Permisos; 
	String Prerequisitos; 
	
	public Tipo_Usuario_old(int Nro_Solucion, String Desc_Corta, String Desc_Larga, int Error, Date Fecha, int Resolutor, 
	...
	public Tipo_Usuario_old() {}
	public  ArrayList<Tipo_Usuario_old> List_Soluciones_Usuario (Errores err) throws SQLException {
		java.sql.PreparedStatement ps= null; 
		ResultSet rs = null; 
		Conectar db= new Conectar(); 
		ArrayList<Tipo_Usuario_old> soluciones = new ArrayList<Tipo_Usuario_old>(); 
		try {	
			...
			while (rs.next()) {
				...
				Tipo_Usuario_old sol = new Tipo_Usuario_old(Id_Solucion, Desc_Corta, Desc_Larga, Id_Error,  Fecha,  Id_Resolutor, 
