...
public class Tipo_Tecnica1 extends Soluciones1{ 
		String Script; 
		String Herramienta;  
		
		public Tipo_Tecnica1(int Nro_Solucion, String Desc_Corta, String Desc_Larga, int Error, Date Fecha, int Resolutor, 
		...
		public Tipo_Tecnica1() {}
		
		
		public  ArrayList<Tipo_Tecnica1> List_Sol (Errores err) throws SQLException {
			java.sql.PreparedStatement ps= null; 
			ResultSet rs = null; 
			Conectar db= new Conectar(); 
			ArrayList<Tipo_Tecnica1> soluciones = new ArrayList<Tipo_Tecnica1>(); 
			try {	 
				...
				while (rs.next()) {
					...
					Tipo_Tecnica1 sol = new Tipo_Tecnica1(Id_Solucion, Desc_Corta, Desc_Larga, Id_Error,  Fecha,  Id_Resolutor, Script, Herramienta); 
					soluciones.add(sol);  
				}		
		...
		public void List_Soluciones(Errores err_inc) {
			try {	
			ArrayList<Tipo_Tecnica1> Soluciones_T_Encontradas =  List_Sol(err_inc);  
