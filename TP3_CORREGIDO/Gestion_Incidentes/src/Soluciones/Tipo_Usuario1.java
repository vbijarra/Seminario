...
public class Tipo_Usuario1 extends Soluciones1{
	String Path; 
	String Permisos; 
	String Prerequisitos; 
	
	public Tipo_Usuario1(int Nro_Solucion, String Desc_Corta, String Desc_Larga, int Error, Date Fecha, int Resolutor, 
	...
	public  ArrayList<Tipo_Usuario1> List_Sol (Errores err) throws SQLException {
		java.sql.PreparedStatement ps= null; 
		ResultSet rs = null; 
		Conectar db= new Conectar(); 
		ArrayList<Tipo_Usuario1> soluciones = new ArrayList<Tipo_Usuario1>(); 
		try {	
			...
			while (rs.next()) {
				...
				Tipo_Usuario1 sol = new Tipo_Usuario1(Id_Solucion, Desc_Corta, Desc_Larga, Id_Error,  Fecha,  Id_Resolutor, 
	...
	public void List_Soluciones(Errores err_inc) {
		try {	
		ArrayList<Tipo_Usuario1> Soluciones_U_Encontradas =  List_Sol(err_inc);   //List_Soluciones_Usuario
