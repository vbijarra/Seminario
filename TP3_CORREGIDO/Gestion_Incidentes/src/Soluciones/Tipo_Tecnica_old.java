...
public class Tipo_Tecnica_old extends Soluciones_old{ 
		String Script; 
		String Herramienta;  
		
		public Tipo_Tecnica_old(int Nro_Solucion, String Desc_Corta, String Desc_Larga, int Error, Date Fecha, int Resolutor, 
		...
		public Tipo_Tecnica_old() {}
		
		
		public  ArrayList<Tipo_Tecnica_old> List_Soluciones_Tecnicas (Errores err) throws SQLException {
			java.sql.PreparedStatement ps= null; 
			ResultSet rs = null; 
			Conectar db= new Conectar(); 
			ArrayList<Tipo_Tecnica_old> soluciones = new ArrayList<Tipo_Tecnica_old>(); 
			try {	 
				...
				while (rs.next()) {
					...
					Tipo_Tecnica_old sol = new Tipo_Tecnica_old(Id_Solucion, Desc_Corta, Desc_Larga, Id_Error,  Fecha,  Id_Resolutor, Script, Herramienta); 
					soluciones.add(sol);  
				}		
