...
public abstract  class Soluciones1 {
	...
	public Soluciones1 (int Nro_Solucion,	String Desc_Corta, 	String Desc_Larga,	int Error, 	Date Fecha, int Resolutor) {
...
/*public void Obtener_Soluciones(int tipo_usu, Errores err_inc) throws SQLException { 
	...
	if (tipo_usu==1)  
	{
		Tipo_Usuario1 tip_usu = new Tipo_Usuario1(); 
		ArrayList<Tipo_Usuario1> Soluciones_U_Encontradas =  tip_usu.List_Soluciones(err_inc);   //List_Soluciones_Usuario
		...
		Tipo_Tecnica1 tip_tec = new Tipo_Tecnica1(); 
		ArrayList<Tipo_Tecnica1> Soluciones_Encontradas =  tip_tec.List_Soluciones(err_inc);
